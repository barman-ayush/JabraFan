...
function MatchCard({ match }: { match: Match }) {
  ...
  return (
    <div 
      className="group h-full transition-all duration-300 hover:translate-x-1 px-8 py-5"
    >
        ...
        <CardHeader className="bg-purple-900/80 pb-2 border-b border-purple-800">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-lg font-bold text-pink-100">{match.league}</CardTitle>
            </div>
            
            {/* Dynamic match status badge */}
            {isCompleted ? (
              <Badge variant="secondary" className="bg-purple-800 text-pink-100 hover:bg-purple-700">Completed</Badge>
            ) : isLive ? (
        ...
        <CardContent className="pt-6 pb-4 flex-grow flex flex-col">
          <div className="flex justify-between items-center bg-purple-900/50 rounded-lg p-4 shadow-md transition-all duration-300 group-hover:bg-purple-900/70">
            <div className="flex flex-col items-center text-center w-5/12">
              ...
              <h3 className="font-semibold text-sm text-pink-100">{match.team1}</h3>
            </div>

            <div className="flex flex-col items-center justify-center w-2/12">
              <div className="text-lg font-bold text-pink-300 bg-purple-950 px-3 py-1 rounded-full border border-purple-800 transition-all duration-300 group-hover:border-purple-700">VS</div>
            </div>
            ...
            <div className="flex flex-col items-center text-center w-5/12">
              ...
              <h3 className="font-semibold text-sm text-pink-100">{match.team2}</h3>
            </div>
          </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="font-medium text-sm text-pink-100">Match Questions</h4>
                  </div>
                  <Badge variant="outline" className="text-xs bg-purple-900 text-pink-100 border-purple-800">
                ...
                <div className="w-full pl-12">
                  ...
                  >
                    ...
                    <span className="text-pink-300 font-bold group-hover:translate-x-1 transition-transform">→</span>
                  </Link>
                </div>
              </div>
            </div>
