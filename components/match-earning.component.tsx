...
const MatchEarnings = ({ matchId, matchDate }: { matchId: string; matchDate: Date }) => {
  ...
  useEffect(() => {
    const fetchUserStats = async () => {
      ...
      try {
        ...
        setError("Could not load your match statistics. Please try again later.");
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-muted/30 p-4 rounded-lg text-center">
                  <p className="text-sm text-muted-foreground mb-1">Base Credits</p>
              ...
              <div className="mt-2">
                ...
                <Progress 
                  value={(stats.answeredQuestions / stats.totalQuestions) * 100} 
                  className="h-2" 
                />
                <p className="text-xs text-muted-foreground mt-1">
                  {stats.correctAnswers} correct answers ({Math.round((stats.correctAnswers / Math.max(1, stats.answeredQuestions)) * 100)}% accuracy)
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="grid grid-cols-3 text-center border-b">
                  ...
                  <div className="p-3 border-r">
                    ...
                    <p className="font-bold">₹{stats.prizeInfo.secondPrize}</p>
                  </div>
